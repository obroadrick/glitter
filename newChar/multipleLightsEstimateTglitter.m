% multipleLightsEstimateTglitter.m
% there are multiple point light sources now and we even know where they
% are, can we estimate the camera position? yes:

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% then we also will make the version that says, there are mulitiple light
% positions and we know only where they are relative to each other (in a
% plane at these positions relative to each other) can we now estimate both
% the light positions and the camera position? yes:
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
