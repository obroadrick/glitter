% estimate rotation and focal lengthmostInliersSpecPos
...
function rotAndIntrinsics = estimateRKglitter(impath, camPosEst, pin, mostInliersSpecPos, mostInliersImageSpecPos)
    ...
    pin = double([pinx' piny']);%pin = [1642.2677 5380.783; 1337.9928 733.52966; 6572.239 726.0792; 6226.173 5270.477];
    %}
    ...
    % output results (R and K which are the outputs and RK which is closer to
    % what was estimated)
    %{
    disp('K');
    disp(K);
    ...
    %% draw the scene with camera and its frustrum for fun and debugging
    figure;
