...
%function [t, R] = findCamPos(P, camParams, imPath, pin)
    ...
    line([origin_in_glitter_coords2d(1) yfar_in_glitter_coords2d(1)], [origin_in_glitter_coords2d(2) yfar_in_glitter_coords2d(2)]);
    ...
    plot(pin(:,1),pin(:,2),'gx');
    figure;
    plot(xfar_in_glitter_coords2d(1), xfar_in_glitter_coords2d(2),'r+');hold on;
    plot(yfar_in_glitter_coords2d(1), yfar_in_glitter_coords2d(2),'rx');
